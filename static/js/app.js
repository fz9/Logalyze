  ...
  function renderTable(data) {
    ...
    data.forEach((logEntry, index) => {
      ...
      row.innerHTML = `
        ...
        <td class="timestamp-cell">${logEntry.timestamp}</td>
        ...
        <td class="request-cell" title="${logEntry.request_line}">${logEntry.request_line}</td>
        <td class="status-cell">
          <span class="status-badge ${statusClass}">${logEntry.response_status}</span>
        </td>
